...
The repository is set up as a monorepo:

- `Client/` is the Vite frontend for Vercel.
- `Server/` is the Express API for Render.

### Vercel Frontend

Set the Vercel project root to `Client/`, then configure:
...
Use the `render.yaml` blueprint from the repository root or create a Web Service with:

- Root directory: `Server/`
- Build command: `npm install`
- Start command: `npm start`
- Environment variables: `MONGODB_URI`, `JWT_SECRET`, `CLIENT_URLS`

`CLIENT_URLS` should include your Vercel domain and any local development origins you want to permit, separated by commas.
...
PORT=3000
CLIENT_URLS="http://localhost:5173,https://your-vercel-project.vercel.app"
...
For any questions or suggestions, please reach out to [dabasaborifan@gmail.com](mailto:dabasaborifan@gmail.com).
